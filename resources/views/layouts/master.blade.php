...
<head>
    ...
    <style>
        body {
            background-image: url("{{ asset('dist/img/bg2.jpg') }}");
...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__wobble" src="{{ asset('dist/img/cafe.png') }}" alt="AdminLTELogo" height="150" width="150">
        </div>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="" class="brand-link">
                <img src="{{ asset('dist/img/cafe.png') }}" alt="AdminLTE Logo" class="brand-image img-circle">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{asset('userimages/'.Auth::user()->image)}}" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                ...
                <nav class="mt-2">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="/sorder/create" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="/orders/ {{ Auth::user()->id }}" class="nav-link">
                                <i class="nav-icon fas fa-running"></i>
                                <p>
                                    My Orders
                                </p>
